package com.example.omar.grocery_list.Data;
...
import com.example.omar.grocery_list.Util.Constants;
...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public void addGrocery(Grocery grocery){
        ...
        values.put(Constants.KEY_QLT_NUMBER , grocery.getQuantity());
    ...
    public Grocery getGrocery(int id){
        ...
        Constants.KEY_QLT_NUMBER ,Constants.KEY_DATE_NAME},Constants.KEY_ID + "=?",
        ...
        if (cursor!=null)
            ...
            grocery.setQuantity(cursor.getString(cursor.getColumnIndex(Constants.KEY_QLT_NUMBER)));
            ...
            grocery.setDataItemAdded(formatDate);
    ...
    public List<Grocery> getAllGrocery(){
        ...
        Cursor cursor = db.query(Constants.TABLE_NAME , new String[]{Constants.KEY_ID,Constants.KEY_GROCERY_ITEM ,
                        Constants.KEY_QLT_NUMBER ,Constants.KEY_DATE_NAME},
    ...
    public int ubdateGrocery(Grocery grocery){
